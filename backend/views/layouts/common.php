                ...
                <?php echo MainSidebarMenu::widget([
                    ...
                    'items' => [
                        ...
                        [
                            ...
                            'active' => Yii::$app->controller->id === 'level',
                        ],
                        [
                            'label' => Yii::t('backend', 'Themes'),
                            'url' => ['/theme/index'],
                            'icon' => FAS::icon('anchor', ['class' => ['nav-icon']]),
                            'active' => Yii::$app->controller->id === 'theme',
                        ],
                        [
                            'label' => Yii::t('backend', 'Words'),
                            'url' => ['/word/index'],
                            'icon' => FAS::icon('file-word', ['class' => ['nav-icon']]),
